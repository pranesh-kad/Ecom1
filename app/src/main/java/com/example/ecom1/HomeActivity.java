...
import com.example.ecom1.Viewholder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //without this we cannot start any operations in onNavigationItemSelected listener
        ...
        Picasso.get().load(Prevalent.currentOnlineUser.
               getImage()).placeholder(R.drawable.profile)
